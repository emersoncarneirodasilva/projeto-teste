    ...
    return (
        <>
            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                />
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#20ff32] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:justify-center lg:col-start-2">
                                <svg
                                    className="h-12 w-auto text-white lg:h-16 lg:text-[#20ff58]"
                                    viewBox="0 0 62 65"
                                    fill="none"
